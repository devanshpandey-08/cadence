...
/* Crash boundary — a render error shows a recovery screen instead of a blank page,
   and the payload survives for the error report (Sentry in production). */
