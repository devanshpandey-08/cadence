...
const P: Record<string, ReactNode> = {
  ...
  card: <><rect x="2.5" y="5" width="19" height="14" rx="2.2" /><path d="M2.5 10h19" /><path d="M6.5 15h4" /></>,
  pulse: <path d="M2.5 12h4l2.5-6.5L13 18l2.5-6h6" />,
  server: <><rect x="3.5" y="3.5" width="17" height="7" rx="1.8" /><rect x="3.5" y="13.5" width="17" height="7" rx="1.8" /><path d="M7 7h.01M7 17h.01" /></>,
  checklist: <><path d="m3.5 5.5 2 2 3.5-4" /><path d="m3.5 13.5 2 2 3.5-4" /><path d="M12 6.5h8.5M12 14.5h8.5" /><path d="M3.5 20.5h17" /></>,
